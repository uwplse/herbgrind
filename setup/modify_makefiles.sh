...
awk -i inplace '/^TOOL_DEPENDENCIES_@VGCONF_PLATFORM_PRI_CAPS@ =/{print;print "\t$(extra_deps_amd64) \\";next}1' ../valgrind/Makefile.tool.am
awk -i inplace '/^TOOL_DEPENDENCIES_@VGCONF_PLATFORM_SEC_CAPS@ =/{print;print "\t$(extra_deps_i386) \\";next}1' ../valgrind/Makefile.tool.am
